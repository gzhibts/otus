...
public class HomeWork {
    ...
    public static void main(String[] args) {
        ...
        EntitySQLMetaData entitySQLMetaDataClient = new EntitySQLMetaDataImpl<>((EntityClassMetaDataImpl<Client>) entityClassMetaDataClient);
        ...
        EntitySQLMetaData entitySQLMetaDataManager = new EntitySQLMetaDataImpl<>((EntityClassMetaDataImpl<Manager>) entityClassMetaDataManager);
