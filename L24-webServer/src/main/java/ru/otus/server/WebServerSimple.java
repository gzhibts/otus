...
public class WebServerSimple implements WebServer {
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new ClientsListServlet(templateProcessor, dbServiceClient)), "/clients");
        servletContextHandler.addServlet(new ServletHolder(new AddClientServlet(dbServiceClient, templateProcessor, gson)), "/add");
        return servletContextHandler;
    }
}
